...
class BertForTokenClassificationConcatCLS(BertPreTrainedModel):
...
class BertForTokenClassificationATT(BertPreTrainedModel):
...
class BertForTokenClassificationONATT(BertPreTrainedModel):

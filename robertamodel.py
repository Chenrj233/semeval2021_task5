...
class RobertaForTokenClassificationCLS(RobertaPreTrainedModel):
...
class RobertaForTokenClassificationConcatCLS(RobertaPreTrainedModel):
    authorized_unexpected_keys = [r"pooler"]
    authorized_missing_keys = [r"position_ids"]
...
class RobertaForTokenClassificationATT(RobertaPreTrainedModel):
    authorized_unexpected_keys = [r"pooler"]
    authorized_missing_keys = [r"position_ids"]
    ...
    def forward(
        ...
        sequence_output = torch.cat(sequence_output).view(layers, batchsize, length, hidden_size)
...
class RobertaForTokenClassificationONATT(RobertaPreTrainedModel):
    authorized_unexpected_keys = [r"pooler"]
    authorized_missing_keys = [r"position_ids"]
